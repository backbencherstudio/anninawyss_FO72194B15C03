...
class ActivateSupportEnvironment extends StatefulWidget {
  const ActivateSupportEnvironment({super.key});

  @override
  State<ActivateSupportEnvironment> createState() => _ActivateSupportEnvironmentState();
}

class _ActivateSupportEnvironmentState extends State<ActivateSupportEnvironment> {
  @override
