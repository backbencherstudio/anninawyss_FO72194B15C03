...
import 'package:anninawyss_o72194b15c03/presentation/all_module/module_two/provider/important_term_provider.dart';
...
import '../widgets/custom_narcissism_tile.dart';
import 'package:anninawyss_o72194b15c03/presentation/widgets/custom_app_bar.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flutter_screenutil/flutter_screenutil.dart';

class ImportantTerms extends ConsumerWidget {
  const ImportantTerms({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final importantItem = ref.watch(importantTermProvider);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Important Terms", style: AppTextStyles.nunitoS18BoldC2F2A29,),
                    ),
                    Expanded(
                      child: ListView.builder(
                        padding: const EdgeInsets.all(16),
                        itemCount: importantItem.length,
                        itemBuilder: (context, index) {
                          final item = importantItem[index];
                          return Container(
